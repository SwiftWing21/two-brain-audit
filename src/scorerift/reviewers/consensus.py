...
from scorerift.reviewers.budget import BudgetGuard  # noqa: TCH001
from scorerift.reviewers.cache import ReviewCache  # noqa: TCH001
    ...
    for provider in providers:
        if cache:
            ...
            if cached:
                ...
                cache_hits += 1
                from scorerift.reviewers.providers import ReviewResult as RR
